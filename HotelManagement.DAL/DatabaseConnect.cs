...
namespace DAL
{
    ...
    {
        //private static string connectionString = @"Data Source=TRANMAILAN;Initial Catalog=QLKhachSan;Integrated Security=True;Trust Server Certificate=True";
        private static string connectionString =
    Environment.GetEnvironmentVariable("DB_CONNECTION")
    ?? @"Data Source=TRANMAILAN;Initial Catalog=QLKhachSan;Integrated Security=True;Encrypt=False;TrustServerCertificate=True";
